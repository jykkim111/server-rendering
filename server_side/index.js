...
socketServer.on('connection', function (socket){
    ...
    socket.on('message', function (data) {
        try{
            ...
            client.connect({port:8083, host: 'localhost'}, function(){
                connName = "rendering Manager"
                ...
                this.on('data', function(data) {
                    ...
                    let axial_dir = server_directory + '/axial.jpeg';    //data_from_mgr[]
                    let sagittal_dir = server_directory + '/sagittal.jpeg'
                    let coronal_dir = server_directory + '/coronal.jpeg'
                    let axial_json = JSON.parse(fs.readFileSync(server_directory + '/axial.json'));
                    let sagittal_json = JSON.parse(fs.readFileSync(server_directory + '/sagittal.json'));
                    let coronal_json = JSON.parse(fs.readFileSync( server_directory + '/coronal.json'));
                ...
                this.on('error', function(err) {
                  console.log('Socket Error: ', JSON.stringify(err.stack));
                });
