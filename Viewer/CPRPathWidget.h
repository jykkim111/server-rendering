...
class CPRPathWidget : public QGraphicsView
{
	Q_OBJECT

public:
	CPRPathWidget(QWidget* parent, const char* name = NULL, SliceType slice_type = AXIAL_SLICE);
...
signals:
	void sigResize(int, int, CPRPathWidget*);
